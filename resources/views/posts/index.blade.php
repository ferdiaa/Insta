                        ...
                        <div class="card-body px-3 py-2">
                            ...
                            <div class="flex-row">
                                ...
                                <p class="card-text mb-1">
                                    <a href="/profile/{{$post->user->username}}" data-toggle="tooltip" data-placement="top" title="{{(count($post->user->profile->followers))}} followers" class="my-0 text-dark text-decoration-none">
